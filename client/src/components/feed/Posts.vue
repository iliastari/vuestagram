   ...
   <article v-for="(post, index) in posts" :key="post.id" class="posts">
        ...
        <div class="post-bottom">
            <div class="top-bar">
                ...
                <!-- Red heart -->
                <svg v-if="userLiked(post.id, userData('id'))" @click="unlikePost(post.id, userData('id'), index)" class="heart liked" viewBox="0 -28 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="likes">
               <span class="number">2</span> likes
            </div>
...
export default {
  ...
  methods: {
    ...
    async unlikePost(post_id, user_id, index) {
        try {
